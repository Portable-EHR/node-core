...
class Node {
    ...
    constructor (nodeName, {appAlias, appGuid, appVersion},
        ...
        Object.defineProperty(this, "myDao", {configurable:true, value: null});
        ...
        Object.defineProperty(this, "_nodecore_initialize", {configurable:true, value: async function(app, logger) {
            ...
            //  First require lib/my-dao. The pool connection is initialized here !
            const { myDao } = Object.defineProperty(this, "myDao", {value: require('./my-dao')});
            //  May throw! Catch by NodeServerApp and bailOut!           //  non-configurable anymore.
            const { myPool } = Object.defineProperty(this, "myPool", {value: await myDao.poolConnectionTestPromise});
