...
class NodeConfig {
    ...
    constructor(srcJsOb, node) {
        ...
        Object.defineProperty(this, '_selfRestServer', {configurable:true, value: new Endpoint(selfRestServer, this, endpoint => SelfWebRequestMethods(endpoint, this))});
        ...
        if (selfCliWsServerAlias) {
            if (undefined === selfCliWsServer) {
                configLogger().bailOut(`netFlavor [${netFlavorAlias}] .selfCliServer: "${selfCliWsServerAlias}" definition not found in .selfCliServers {} section of config file [${configFQN}].`);
            }
