...
const isInvalidEmail = v =>
                            isInvalidString(v)  ||  ! validateEmailServerNameFormat(v); //  if '', null or undefined: true

const isInvalidProvidedEmail = v =>
        isProvided(v) && (isInvalidString(v) || (v && !validateEmailServerNameFormat(v))); //  if '', null or undefined: false
