...
class LaunchParams {
    constructor({e:environment, a:application, i:instance, p:process, n:netFlavor, f:feedFlavor, r:rootPath, c:configFileName}) {
        Object.assign(this, { environment, application, instance, process, netFlavor, feedFlavor, rootPath, configFileName });
    }
    ...
    get instancePath() { return `${this.rootPath}/${this.environment}/${this.application}/${this.application}.${this.instance}`; }
