...
function* allProtoFunctionsAlongThePrototypeChain(o) {
    ...
    while (proto.constructor !== Object) {
        for (let propName of Object.getOwnPropertyNames(proto)) {
            if (propName !== "constructor") {                                               //  Skip constructor.
...
Object.assign(self, {allProtoFunctionsAlongThePrototypeChain});
...
self.intFromXml = theArg => {                                                   //  Legacy function
    if ('string' === typeof theArg) return parseInt(theArg);
    if ('number' == typeof theArg) return theArg;
...
// console.log(self.normalizePhoneNumber(['(635) 753-1073', null, undefined][ 2 ]));
// console.log('fin');
...
class Cycling {
    ...
    }   //  Can be overridden, for instance to provide a cycle of cycles (MobileMed spi.nao PullChunkSliceByTimeSliceBatch)
