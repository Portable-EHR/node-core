...
const getPoolConnectionAsync = () => new Promise( (fulfill, reject) => {
    const errMsg = "Unable to get new MY-DB connection from pool :\n";
    try {
        pool.getConnection((e, connection)=>{
            if (e) {
    ...
    return await(new Promise( (fulfill, reject) => {
        connection.query(insertQueryString, args, (e, results) => {
            ...
            if (e) reject(e);
                ...
                else reject(NoRow(`dbInsert : insertId [${insertId}] < 1, performing MY-DB query :\n"${
...
const dbUpdate = async (updateQueryString, args=[], filterResults=(results, reject) => {
                            ...
                            reject(NoRow(`dbUpdate : changedRows [${changedRows}] < 1, performing MY-DB query :\n"${
...
const dbDelete = async (deleteQueryString, args=[], filterResults=(results, reject)=>{
                            ...
                            reject(NoRow(`dbDelete : affectedRows [${affectedRows}] < 1, performing MY-DB query :\n"${
