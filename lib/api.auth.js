...
const { apiUsers, nodeJwtKeysFQN, } = node;
...
const BuildNodeApiResponse = node.isFeedHub ? BuildFeedHubApiResponse : BuildFeedApiResponse;
const ENodeRequestStatus   = node.isFeedHub ? EFeedHubRequestStatus   : EFeedRequestStatus;
