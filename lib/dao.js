...
const{ repr, niceJSON, DeclareExpectedError, ErrorExtender, Enum, EItem, }= require('./utils');
            ...
            pool.getConnection((e, connection)=>{
                if (e) {
                    ...
                    connection.query('select 1+1 as answer', (e, results)=> {
                        ...
                        logger.info(`Database connection pool to [${database}] of [${host}:${port}] configured and functional! [1+1=${answer}]`);
                        fulfill(pool);
                    });
                }
            });
